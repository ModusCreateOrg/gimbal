...
import cliRenderer from '@/components/Table/renderer/cli';
import htmlRenderer from '@/components/Table/renderer/html';
import markdownRenderer from '@/components/Table/renderer/markdown';
